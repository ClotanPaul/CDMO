...
def run_minizinc_on_all(dzn_files_dir, model_file, output_dir, timeout=300, solver = "gecode", symmetry_breaking = False, seed = 42):
    """
    ...
    instances_to_include = [13,16] #list(range(13, 22)) #list(range(1, 11))+ 
...
model_files = ['./model_restart_symbreak.mzn']  # './model.mzn', 
# minizinc models(with and without symbreak)
